...
return (
    ...
    {loading && <Spinner/>}
    <BottomAddToFavorite product={product} favorite={favorite} setFavorite={setFavorite} updateFavorite={updateFavorite} setUpdateFavorite={setUpdateFavorite} />
    </>
)
}
...
function BottomAddToFavorite({product, favorite, updateFavorite, setFavorite, setUpdateFavorite}) {
        ...
        <div className="bottomAddToFav-container">
           ...
           <div className="flex items-center">
            ...
            <div className="flex items-center">
                ...
                {!favorite && getFavId.includes(product.id) ? <button onClick={handleRemoveFromFavorite} className="bottomAddToFav-btn">Remove from favorite ({updateFavorite})</button> : <button onClick={handleAddToFavorite} className="bottomAddToFav-btn">Add to favorite ({updateFavorite})</button>}
            </div>
           </div>
