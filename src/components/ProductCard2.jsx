	...
	return (
	  <div className="product-card-container">
		<div>
		  ...
		  <img onClick={() => handleProductDetail(product.id)}
		  ...
		  <div className="px-6 py-3 sm:px-2 sm:py-1 sm:flex sm:justify-between sm:items-center">
			<p onClick={() => handleProductDetail(product.id)} className="product-card--model">
			  {product.title}
			</p>
			<div onClick={() => handleProductDetail(product.id)} className="sm:hidden">
		  ...
		  <div onClick={() => handleProductDetail(product.id)} className="px-6 pt-0 flex justify-between sm:px-2">
